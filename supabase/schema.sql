...
create index service_intervals_user_id_idx on public.service_intervals(user_id);
create index service_intervals_vehicle_id_idx on public.service_intervals(vehicle_id);
